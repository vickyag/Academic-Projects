...
%data = data./100;
d1 = load('Assignment_Data_Split\Real\C_1_Train.txt');
d2 = load('Assignment_Data_Split\Real\C_2_Train.txt');
d3 = load('Assignment_Data_Split\Real\C_3_Train.txt');
%d1 = d1/100;
%d2 = d2/100;
%d3 = d3/100;
...
t1 = load('Assignment_Data_Split\Real\C_1_Valid.txt');
t2 = load('Assignment_Data_Split\Real\C_2_Valid.txt');
t3 = load('Assignment_Data_Split\Real\C_3_Valid.txt');
%t1 = t1/100;
%t2 = t2/100;
%t3 = t3/100;
...
fid=fopen('rd_c1_fp_arr.txt','wt');
fprintf(fid, '%f ', fp_arr');
fclose(fid);

fid=fopen('rd_c1_tp_arr.txt','wt');
fprintf(fid, '%f ', tp_arr');
fclose(fid);

fid=fopen('rd_c1_fn_arr.txt','wt');
...
min1 = min(d1);
max1 = max(d1);
x11 = min1(1,1):20:max1(1,1);
x12 = min1(1,2):20:max1(1,2);
...
min2 = min(d2);
max2 = max(d2);
x21 = min2(1,1):20:max2(1,1);
x22 = min2(1,2):20:max2(1,2);
...
min3 = min(d3);
max3 = max(d3);
x31 = min3(1,1):20:max3(1,1);
x32 = min3(1,2):20:max3(1,2);
