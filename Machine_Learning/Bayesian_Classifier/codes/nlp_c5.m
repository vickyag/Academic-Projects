...
%data = data./100;
d1 = load('Assignment_Data_Split\Non_Linear_Separable\C_1_Train.txt');
d2 = load('Assignment_Data_Split\Non_Linear_Separable\C_2_Train.txt');
d3 = load('Assignment_Data_Split\Non_Linear_Separable\C_3_Train.txt');
%d1 = d1/100;
%d2 = d2/100;
%d3 = d3/100;
...
t1 = load('Assignment_Data_Split\Non_Linear_Separable\C_1_Valid.txt');
t2 = load('Assignment_Data_Split\Non_Linear_Separable\C_2_Valid.txt');
t3 = load('Assignment_Data_Split\Non_Linear_Separable\C_3_Valid.txt');
%t1 = t1/100;
%t2 = t2/100;
%t3 = t3/100;
...
plot(fp_arr,fn_arr);
     ...
     fid=fopen('nls_c5_fp_arr.txt','wt');
fprintf(fid, '%f ', fp_arr');
fclose(fid);

fid=fopen('nls_c5_tp_arr.txt','wt');
fprintf(fid, '%f ', tp_arr');
fclose(fid);

fid=fopen('nls_c5_fn_arr.txt','wt');
